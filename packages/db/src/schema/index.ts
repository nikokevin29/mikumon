...
export const userProfiles = pgTable(
  'user_profiles',
  {
    ...
    limitBytesTotal: bigint('limit_bytes_total', { mode: 'bigint' }),
    limitBytesDown: bigint('limit_bytes_down', { mode: 'bigint' }),
    limitBytesUp: bigint('limit_bytes_up', { mode: 'bigint' }),
...
export const hotspotActiveSessions = pgTable('hotspot_active_sessions', {
  ...
  uploadBytes: bigint('upload_bytes', { mode: 'bigint' }).default(0n),
  downloadBytes: bigint('download_bytes', { mode: 'bigint' }).default(0n),
